...
<head>
  ...
  <!-- Font Awesome -->
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css" integrity="sha512-iecdLmaskl7CVkqkXNQ/ZH/XLlvWZOJyj7Yy7tcenmpD1ypASozpmT/E0iPtmFIB46ZmdtAc9eNBvH0H/ZpiBw==" crossorigin="anonymous" referrerpolicy="no-referrerv" />

  <title>Gestion Des Athlete</title>
</head>

<body>
  <nav class="navbar navbar-light justify-content-center fs-3 mb-5" style="background-color: #DCDCDC;">
  <a href="inde.php"><img src="Logo-ims.png" alt="" width=100px></a>
  <h3>Gestion Des Athlete</h3>
  </nav>

  <div class="container">
    <div class="text-center mb-4">
      <h3>Edit Athlete Information</h3>
    ...
    <div class="container d-flex justify-content-center">
      <form action="" method="post" style="width:50vw; min-width:300px;">
        ...
        <div class="col">
            ...
            <input type="text" class="form-control" name="type_de_sport" value="<?php echo $row['type_de_sport'] ?>" required>
          </div>
